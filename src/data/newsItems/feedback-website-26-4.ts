...
export const feedbackWebsite264: NewsItem = {
    url: "/artigo/feedback-26-4",
    hide: false,
    ...
    content: `
      <main>
        ...
        <p>
          É bem simples, basta acessar nosso website, navegue por alguns minutos entre as páginas e divisões iSKGtm, e depois envie suas respostas com base na sua experiência.
        </p>

        <p>
          Você pode responder usando estas perguntas como referência:
        </p>

        <ul>
          <li>Você entendeu a proposta do site?</li>
          <li>Foi fácil navegar entre as páginas e divisões?</li>
          <li>O visual parece profissional?</li>
          <li>Teve alguma dificuldade?</li>
          <li>De 1 a 5, qual nota você daria para a facilidade de uso?</li>
        ...
        <p>
          Envie suas respostas para <a href="mailto:maximosenamaximo@gmail.com">maximosenamaximo@gmail.com</a> ou <a href="/hub">clique aqui</a> para mais opções de contato.
        </p>
